package com.xiaomi.infrastructure.dbrouter;
 ...
 * Package: com.xiaomi.config.dbrouter
 */
@Aspect
public class DBRouterJoinPoint {
    ...
    @Pointcut("@annotation(com.xiaomi.infrastructure.dbrouter.annotation.DBRouter)")
